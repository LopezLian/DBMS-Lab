...
namespace Lab_1
{
    public partial class Form1 : Form
    {
        ...
        {
            Op1 = this.textBox1.Text; Operator = '+'; input = string.Empty;
        }
        ...
        {
            Op2 = input; double num1, num2; double.TryParse(Op1, out num1); double.TryParse(Op2, out num2); 
            if (Operator == '+')
{
...
textBox1.Text = "DIV/Zero!";
            ...
            {
                res = Math.Log10(num1); textBox1.Text = res.ToString();
            }
            else if (Operator == 'R')
            {
                res = Math.Sqrt(num1); textBox1.Text = res.ToString();
            }
            else if (Operator == 'P')
            {
                res = num1* Math.PI; textBox1.Text = res.ToString();
            }
...
input = string.Empty;
        ...
        {
            Op1 = this.textBox1.Text; Operator = 'L'; input = string.Empty;
        }

        private void button18_Click(object sender, EventArgs e)
        {
         Op1 = this.textBox1.Text; Operator = 'R'; input = string.Empty;
        }

        private void button20_Click(object sender, EventArgs e)
        {
            Op1 = this.textBox1.Text; Operator = 'P'; input = string.Empty;
        }
    }
}
